...
export default function AuthLayout({ children }: Readonly<{ children: ReactNode }>) {
  return (
    <div className="relative min-h-screen w-screen overflow-hidden bg-[#050507] text-white">
      ...
      <div className="relative flex min-h-screen w-screen items-stretch justify-stretch">
        {children}
      </div>
    </div>
  );
