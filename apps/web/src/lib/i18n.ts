...
const COPY: Record<AppLocale, { shell: ShellCopy; auth: AuthCopy }> = {
  ...
  fr: {
    ...
    auth: {
      ...
      submitForgot: "Ouvrir le support",
      loading: "Chargement...",
  ...
  pt: {
    ...
    auth: {
      ...
      forgotPassword: "Precisas de ajuda?",
