...
const COPY: Record<AppLocale, { shell: ShellCopy; auth: AuthCopy }> = {
  nl: {
    ...
    auth: {
      ...
      registerSubtitle: "Kies je username, maak je profiel aan, ontvang een code via mail en activeer je account in de volgende stap.",
      ...
      usernamePlaceholder: "jouw.username",
      usernameHelper: "Zo kunnen anderen je zoeken en toevoegen.",
  ...
  en: {
    ...
    auth: {
      ...
      registerSubtitle: "Choose your username, set up your profile, get a code by email and activate your account in the next step.",
      ...
      usernameHelper: "This is how other people can search and add you.",
  ...
  fr: {
    ...
    auth: {
      ...
      registerSubtitle: "Choisissez votre nom d'utilisateur, cr?ez votre profil, recevez un code par e-mail et activez votre compte ? l'?tape suivante.",
      ...
      usernameHelper: "C'est avec ce nom que les autres peuvent vous trouver et vous ajouter.",
  ...
  de: {
    ...
    auth: {
      ...
      registerSubtitle: "W?hle deinen Benutzernamen, richte dein Profil ein, erhalte einen Code per E-Mail und aktiviere dein Konto im n?chsten Schritt.",
      ...
      usernameHelper: "So k?nnen andere dich finden und hinzuf?gen.",
  ...
  es: {
    ...
    auth: {
      ...
      registerSubtitle: "Elige tu nombre de usuario, configura tu perfil, recibe un c?digo por correo y activa tu cuenta en el siguiente paso.",
      ...
      usernameHelper: "As? te pueden buscar y a?adir otras personas.",
  ...
  it: {
    ...
    auth: {
      ...
      registerSubtitle: "Scegli il tuo nome utente, configura il profilo, ricevi un codice via email e attiva il tuo account nel passaggio successivo.",
      ...
      usernamePlaceholder: "tuo.nome",
      usernameHelper: "Cos? gli altri possono trovarti e aggiungerti.",
      firstNameLabel: "Nome",
  ...
  pt: {
    ...
    auth: {
      ...
      registerSubtitle: "Escolhe o teu nome de utilizador, prepara o teu perfil, recebe um c?digo por email e ativa a tua conta no passo seguinte.",
      ...
      usernamePlaceholder: "teu.nome",
      usernameHelper: "? assim que os outros te podem encontrar e adicionar.",
      firstNameLabel: "Nome",
      firstNamePlaceholder: "Nome",
